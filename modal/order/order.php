<?php
	...
	switch($modal){
		...
		$read	= $conn->prepare("SELECT kode_tor, tgl_tor, ket_tor FROM transaksi_order WHERE id_tor=:kode");
...
?>
        ...
        <div class="modal-body">
            ...
            <div class="row">
			 ...
			 <div class="row">
                <div class="form-group col-md-12">
                    <label>Keterangan Order <span class="tx-danger">*</span></label>
                    <input type="text" name="ket_tor" class="form-control" value="<?php echo($view['ket_tor']); ?>" placeholder="Type here..." required="required" />
                    <div id="imgloading"></div>
                </div>
			</div>
        </div>
