...
<?php
	...
	$read	= $conn->prepare("SELECT A.kode_tfk, A.tgl_tfk, A.po_tfk, B.nama_out, B.npwp_out, C.pengiriman_ola FROM transaksi_faktur_r AS A LEFT JOIN outlet AS B ON A.id_out=B.id_out LEFT JOIN outlet_alamat AS C ON B.id_out=C.id_out WHERE A.id_tfk=:kode");
...
?>
    <head>
        ...
        <title> Document Faktur Retur</title>
