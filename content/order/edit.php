    ...
    <div class="component-section no-code">
        ...
        <div class="row row-sm">
            ...
            <div class="col-sm-3">
				...
				<?php
					$master	= $conn->prepare("SELECT id_ksp, nama_ksp FROM kategori_supplier_b ORDER BY nama_ksp ASC");
					$master->execute();
