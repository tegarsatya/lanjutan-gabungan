<div class="content-header">
    <div>
        ...
        <h4 class="content-title">Edit Data - Supplier</h4>
    </div>
</div>
<?php
	$kode	= $secu->injection($_GET['keycode']);
	$read	= $conn->prepare("SELECT A.id_ksp, A.nama_sup, A.cp_sup, A.npwp_sup, B.id_rpo, B.id_rkb, B.telp_sal, B.fax_sal, B.hp_sal, B.email_sal, B.web_sal, B.kopos_sal, B.alamat_sal, C.top_sdi, C.parameter_sdi, C.diskon1_sdi, C.diskon2_sdi FROM supplier_b AS A INNER JOIN supplier_alamat_b AS B ON A.id_sup=B.id_sup LEFT JOIN supplier_diskon_b AS C ON A.id_sup=C.id_sup WHERE A.id_sup=:kode");
